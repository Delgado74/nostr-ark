...
const t: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'convert.withdrawDesc': 'Retira tu saldo Ark a una dirección onchain (bc1...).',
    ...
    'convert.onboardAmountPlaceholder': 'Monto en sats (vacío = todo)',
    'convert.max': 'Máx',
    'convert.withdraw': 'Retirar a onchain',
    'convert.withdrawConfirm': 'Retirar',
    'convert.withdrawing': 'Retirando...',
    'convert.withdrawAddrPlaceholder': 'Dirección destino (bc1...)',
  ...
  en: {
    ...
    'convert.withdrawDesc': 'Withdraw your Ark balance to an on-chain address (bc1...).',
    ...
    'convert.onboardAmountPlaceholder': 'Amount in sats (empty = all)',
    'convert.max': 'Max',
    'convert.withdraw': 'Withdraw on-chain',
    'convert.withdrawConfirm': 'Withdraw',
    'convert.withdrawing': 'Withdrawing...',
    'convert.withdrawAddrPlaceholder': 'Destination address (bc1...)',
