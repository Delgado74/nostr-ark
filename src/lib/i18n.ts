...
const t: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'dash.convert': 'Convertir saldo',
    'dash.convertToArk': 'Convertir a Ark',
    'dash.converting': 'Convirtiendo...',
    'dash.withdraw': 'Retirar a onchain',
    'dash.withdrawConfirm': 'Retirar',
    'dash.withdrawing': 'Retirando...',
    'dash.withdrawAddrPlaceholder': 'Dirección destino (tb1...)',
    'dash.withdrawAmountPlaceholder': 'Monto en sats',
  ...
  en: {
    ...
    'dash.convert': 'Convert balance',
    'dash.convertToArk': 'Convert to Ark',
    'dash.converting': 'Converting...',
    'dash.withdraw': 'Withdraw on-chain',
    'dash.withdrawConfirm': 'Withdraw',
    'dash.withdrawing': 'Withdrawing...',
    'dash.withdrawAddrPlaceholder': 'Destination address (tb1...)',
    'dash.withdrawAmountPlaceholder': 'Amount in sats',
